...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'CANCELLED', 'CHARGEDBACK');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'EZ_CASH', 'GENIE', 'FRIMI', 'IPAY', 'HELAPAY', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "payments_payhereOrderId_key" ON "payments"("payhereOrderId");
